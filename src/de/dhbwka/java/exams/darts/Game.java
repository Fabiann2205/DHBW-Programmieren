...
public class Game {
    ...
    public void start() {
        ...
        while(run) {
            ...
            // input auslesen
            System.out.println("Player: " + players[player].getName() + ", " + players[player].getRemainingPoints() + " points remaining.");
        ...
        input.close();
        try {
            File test = new File("highscore.txt");
            ...
            TextFile text = new TextFile(test);
            if(player == 0) {
...
// allen spielern werden immer alle visits hinzugefügt ab der 2. runde; bei remaining immer das letzte nur vom anderen spieler??
