...
public class MemoryGameTerm {
    ...
    public MemoryGameTerm(MemoryGame game) {
        ...
        List<JToggleButton> toggleButtons = getjToggleButtons(game);
    ...
    private List<JToggleButton> getjToggleButtons(MemoryGame game) {
        ...
        for (int i = 0; i < sizeOfField; i++) {
            ...
            ItemListener itemListener = itemEvent -> {
                ...
                if (state == ItemEvent.SELECTED) {
                    ...
                    item.setIcon(game.getImages().get(Integer.parseInt(item.getText())).image());
                    clicked++;
                } else {
