...
public class Room implements IRoom {
     ...
     * Initalize the room
     *
     * @param factor  factor for the variant
     * @param setting setting for the room
     */
     ...
     * @param x    x value
     * @param y    y value
     * @param dose dose to set at provided position
     */
    @Override
     ...
     * @param x    x value
     * @param y    y value
     * @param dose dose to add at provided position
     */
    @Override
